Shader "Unlit/VDisplacementHLSL_Gianni"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                //v.vertex � la LOCAL vertex position
                v2f o;

                float noiseValue = tex2Dlod(_NoiseTex, float4(v.uv + (0, _Time.x),0,0)); //Utilizzo v.uv e non i.uv perch� qui si chiamano cos�
